...
class SubMenuUpdate extends index_core_1.default {
    constructor() {
        super(SubMenu);
    }
    exec(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let request_data = { nama, menu_id, urutan, icon, url, target };
                let data = yield SubMenu.update(request_data, { where: { id } });
                if (data == 0) {
