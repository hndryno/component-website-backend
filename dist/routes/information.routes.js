...
const create_controller_1 = __importDefault(require("../controllers/informations/create.controller"));
const show_controller_1 = __importDefault(require("../controllers/informations/show.controller"));
const update_controller_1 = __importDefault(require("../controllers/informations/update.controller"));
const delete_controller_1 = __importDefault(require("../controllers/informations/delete.controller"));
const list_controller_1 = __importDefault(require("../controllers/informations/list.controller"));
...
router.get('/', upload.single('image'), (req, res, next) => __awaiter(void 0, void 0, void 0, function* () { return yield new list_controller_1.default().exec(req, res, next); }));
