...
const findByKategori_controller_1 = __importDefault(require("../controllers/artikel/findByKategori.controller"));
...
router.get('/kategori/:id', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () { return yield new findByKategori_controller_1.default().exec(req, res, next); }));
