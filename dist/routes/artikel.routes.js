...
// router.post('/', ArtikelValidation.CreateArtikelValidation, upload.single('image'), async(req:Request, res: Response, next: NextFunction) => await new ArtikelCreate().exec(req, res, next))
router.post('/', artikel_validation_1.default.CreateArtikelValidation, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () { return yield new create_controller_1.default().exec(req, res, next); }));
