...
const create_controller_1 = __importDefault(require("../controllers/category/create.controller"));
const show_controller_1 = __importDefault(require("../controllers/category/show.controller"));
const update_controller_1 = __importDefault(require("../controllers/category/update.controller"));
const delete_controller_1 = __importDefault(require("../controllers/category/delete.controller"));
const list_controller_1 = __importDefault(require("../controllers/category/list.controller"));
